...
termux-core termux-keyring termux-licenses apt dpkg bash brotli \
ca-certificates cmake coreutils diffutils findutils freetype gawk git grep \
gzip harfbuzz less libandroid-glob libandroid-spawn libandroid-support libbz2 \
libc++ libcurl libexpat libffi libgcrypt libgnutls libiconv libjpeg-turbo \
libllvm liblz4 liblzma libmd libopenblas libpng libsqlite libxml2 make nano \
ncurses ndk-sysroot ninja openssl patch pkg-config python python-numpy \
python-pip readline sed tar unzip util-linux xxhash zlib zstd}"
